...
| `--tfworkspace` | `-w` | No | Terraform workspace name (default: `alaska-geoportal-staging` or `alaska-geoportal-prod`) |
| `--help` | `-h` | No | Show help |
...
./scripts/deploy.sh -e prod -w alaska-geoportal-prod-v2
```
